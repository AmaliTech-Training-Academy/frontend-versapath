                            ...
                            stage === "processing" ? (
                                <>
                                    <div className="relative w-11 h-11">
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <span className="text-[10px] text-[#0B0B0B]">{progress}%</span>
                                        </div>
                                    </div>
                                ...
                                <>
                                    ...
                                    <div className="px-6 inline-flex justify-start items-center gap-2.5">
                                        ...
                                        <div className="justify-center text-gray-text-weak text-sm">OR</div>
                                        <div className="w-16 h-px relative bg-gray-stroke-weak" />
                                    </div>
                                    <Button
                                        type="button"
