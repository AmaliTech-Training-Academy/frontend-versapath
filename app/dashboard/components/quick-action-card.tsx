...
export const QuickActionCard = ({ title, description, icon: Icon, url }: QuickActionCardProps) => {
    return (
        <Link href={url} aria-label={title} className="space-y-1 border border-gray-stroke-weak rounded-xl p-4 cursor-pointer hover:shadow-xl">
